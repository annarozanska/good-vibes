...
const CoverVideo = () => {
  return (
    ...
    <Title variants={container} initial='hidden' animate='show'>
        <div>
            <h1 data-scroll data-scroll-delay='0.15' data-scroll-speed='4'>G</h1>
            <h1 data-scroll data-scroll-delay='0.14' data-scroll-speed='4'>o</h1>
            <h1 data-scroll data-scroll-delay='0.13' data-scroll-speed='4'>o</h1>
            <h1 data-scroll data-scroll-delay='0.12' data-scroll-speed='4'>d</h1>
            <h1 data-scroll data-scroll-delay='0.11' data-scroll-speed='4'>&nbsp;</h1>
            <h1 data-scroll data-scroll-delay='0.10' data-scroll-speed='4'>V</h1>
            <h1 data-scroll data-scroll-delay='0.09' data-scroll-speed='4'>i</h1>
            <h1 data-scroll data-scroll-delay='0.08' data-scroll-speed='4'>b</h1>
            <h1 data-scroll data-scroll-delay='0.07' data-scroll-speed='4'>e</h1>
            <h1  data-scroll data-scroll-delay='0.06' data-scroll-speed='4'>s</h1>
        </div>
